...
static webcat::server* g_admin = nullptr;
...
int main(int argc, char** argv)
{
    ...
    //
    meshpp::settings::set_application_name("webcatd");
    ...
    try
    {
        ...
        webcat::admin_server admin(admin_bind_to_address,
                                   fs_library,
                                   fs_admin,
                                   pv_key,
                                   plogger_admin.get(),
        ...
        webcat::storage_server storage(storage_bind_to_address,
                                       fs_storage,
                                       fs_storage_binaries,
        ...
        webcat::worker worker(plogger_worker.get(),
                              fs_worker,
                              direct_channel);
        g_worker = &worker;
